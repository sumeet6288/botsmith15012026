...
// Public APIs (no authentication required - for embeds/widgets)
export const publicAPI = {
  getChatbot: (id) => {
    // Use axios directly without auth interceptor for public endpoints
    return axios.get(`${API_URL}/api/public/chatbot/${id}`);
  },
  sendMessage: (chatbotId, data) => {
    // Use axios directly without auth interceptor for public endpoints
    return axios.post(`${API_URL}/api/public/chat/${chatbotId}`, data);
  },
};
