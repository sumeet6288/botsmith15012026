...
api_router.include_router(widget_version.router)
...
api_router.include_router(billing_audit.router, tags=["Billing Audit"])

# Include the router in the main app
app.include_router(api_router)

# Root-level health check endpoint for Kubernetes (without /api prefix)
@app.get("/health")
